...
# images = [
#     "./ylw-n-black-track-1.jpg", "./ylw-n-black-track-2.jpg", "./red-n-black-track-1.jpg", "./red-n-black-track-2.jpg"
# ]
images = [
    "./ylw-n-black-track-1.jpg",
]
...
for image in images:
    try:
        ...
        cv2.imwrite(f'./{basename}-priCol-{PRIORITY_COLOUR}-iniThreshROI{ext}', thresh_roi)
        time.sleep(0.25)
        ...
        cv2.imwrite(f'./{basename}-priCol-{PRIORITY_COLOUR}-acceptMask{ext}', accept_mask)
        time.sleep(0.25)
        cv2.imwrite(f'./{basename}-priCol-{PRIORITY_COLOUR}-rejectMask{ext}', reject_mask)
        time.sleep(0.25)
        cv2.imwrite(f'./{basename}-priCol-{PRIORITY_COLOUR}-finalThresh{ext}', thresh_roi)
        time.sleep(0.25)
